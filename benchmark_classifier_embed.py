...
def run_single_embed_benchmark(
    ...
    try:
        ...
        # Lưu checkpoint MLP head
        import torch
        model_save_path = os.path.join(model_output_dir, "mlp_head.pt")
        torch.save(mlp.model.state_dict(), model_save_path)
        print(f"  Đã lưu checkpoint MLP head → {model_save_path}")
